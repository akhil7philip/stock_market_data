...
class GeneralScriptOne():
    ...
    def __init__(self, API_KEY, end_point, symbol, exchange, period, limit):
        self.API_KEY, self.end_point, self.symbol, self.exchange, self.period, self.limit = API_KEY, end_point, symbol, exchange, period, limit
    ...
    for arg in args:
        try:
            ...
            for symbol, exchange in zip(symbols, exchanges):
                gs = GeneralScriptOne(api_key, end_point, symbol, exchange, period, limit)
